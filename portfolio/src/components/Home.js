    ...
    return (
        <div className='about'>
            <div className='about-start'>
                <div className='text'>
                    <p>
                        I am a Wife, Mother, Navy Veteran, and a Full Stack Web Developer.
                    </p>
                    <p>
                        I have been working in Web Development in some way ever since I got out of the Navy in 2009.  
                    </p>
                </div>
